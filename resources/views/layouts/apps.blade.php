      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            @role('siswa')
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{url('/absen')}}" aria-expanded="false">
                <span>
                  <i class="ti ti-article"></i>
                </span>
                <span class="hide-menu">Cek Absensi</span>
              </a>
            </li>
            @endrole
            @role('admin')
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{url('/admin/jurusan')}}" aria-expanded="false">
                <span>
                  <i class="ti ti-article"></i>
                </span>
